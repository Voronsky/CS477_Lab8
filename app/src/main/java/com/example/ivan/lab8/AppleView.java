...
public class AppleView extends TileView{
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_POINTER_DOWN: {
                 ...
                 */
                    ...
                    float x = event.getX();
                    float y = event.getY();
                    int xCoord = Math.round(x)/mTileSize;
                    int yCoord = Math.round(y)/mTileSize;
                    System.out.println("loc (w,h) (" + WIDTH + "," + HEIGHT + "): " + x + "," + y);
                    Coordinate userCoords = new Coordinate(xCoord,yCoord);
                    for(int i = 0; i<mAppleList.size();i++){
                        if (userCoords.closeTo(mAppleList.get(i))) {
                            Log.d("touch","mApplesList found the coords touched");
                            speedUp = true;
                            updateApples();
                        }
                    }
    ...
    private class Coordinate {
        ...
        public boolean closeTo(Coordinate other){
            int distance = (x+y) - (other.x+other.y);
